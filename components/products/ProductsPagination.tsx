        ...
        <nav className="flex justify-center gap-2 py-10">
            ...
            {pages.map(currentPage => (
                <Link
                    ...
                    className={`${page === currentPage ? 'font-black text-amber-600' : 'bg-white'} px-4 py-2 text-sm text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-20 focus:-outline-offset-8`}
                >{currentPage}</Link>
            ))}
